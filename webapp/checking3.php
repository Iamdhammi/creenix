                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-7 col-sm-7 col-xs-12 m-lr-auto m-b-50">
                            <div class="p-lr-40 how-shadow1 p-t-30 p-b-40 m-l-63 m-lr-0-xl p-lr-15-sm">
                                ...
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;">E-flyer/Banner Design : ₦10,000.00</h4>
                                ...
                                <div class="stext-111">
                                    ...
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Dynamic Sizes</h4>
                                ...
                                <div class="stext-109 cl2">
                                    <h5 style="color: #71aa68; padding-bottom: 10px;">How many E-flyer/Banner Design?
                                    </h5>
                                </div>
