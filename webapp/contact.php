...
<html>
    <head>
    	...
    	<title>Contact Us | Creenix</title>
    ...
    <body>
        ...
        <div class="fh5co-offcanvas">
            <ul>
                ...
                <li><a href="contact.php"><i class="icon-mail"></i> Send a message</a></li>
            </ul>
        ...
        <section class="fh5co-cover4">
            <div class="container">
                <div class="header-text">
                    <h2 class="text-center">Get in Touch</h2>
                    <p class="text-center">Send us a message and we'll respond asap</p>
                </div>
            </div>
        </section>
         ...
         <!-- Contact -->
        <section id="" class="cont section-padding">
            <div class="container">
                <div class="st-center" style="background: url(assets/images/logo-icon-4.png) no-repeat scroll center ;"></div>
                <div class="space"></div>
                <div class="row text">
                    <div class="col-md-5 col-lg-5 col-sm-6 col-xs-12 add1">
                        <address>
                            <h4><i class="fa fa-map-marker"></i>&nbsp; Address</h4><br>
                            <p>King Jaja Hall University of Lagos,<br>
                            Akoka Yaba</p>
                            <br><br>
                            <h4><i class="icon-mobile"></i>&nbsp; Let's Talk</h4><br>
                            <p><a href="tel://2348094190728" style="text-decoration: none; color: #238ff9">+ 234 812 713 1208</a></p>
                            <p><a href="tel://2348094190728" style="text-decoration: none; color: #238ff9">+ 234 810 538 9434</a></p>
                            <br><br>
                            <h4><i class="icon-mail"></i>&nbsp; Client Support</h4><br>
                            <p><a href="mailto:info@joibecola.com" style="text-decoration: none; color: #238ff9">info@creenix.com</a></p>
                            <br><br>
                        </address>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <form action="php/mail.php" method="post">
                            <!-- <i class="icon-mail iconss"></i> -->
                            <img class="iconsss" src="assets/images/icon-email.png" alt="ICON">
                            <input type="text" name="email" class="xoo stext-111 cl8 plh3 size-111 p-lr-15" placeholder="Your Email" required>
                            <textarea class="xoo stext-111 cl8 plh3 size-111 p-lr-15" rows="4" placeholder="How can we help?"></textarea>
                            <div class="text-center">
                               <button  type="submit" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" id="subscribe-submit" style="margin-top: 20px;"> <a href="#" class="d-flex flex-row align-items-center text-center justify-content-center"> Send a message</a></button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <section id="contact" class="contact">
            <div class="container">
                <div class="section-title">
                    <h2 class="text-center"><a href="landing-page.php#pricing" style="text-decoration: none; color: #666">Have you chosen a package?</a></h2><hr>
                </div>
                <div class="space"></div>
                <div class="row">
