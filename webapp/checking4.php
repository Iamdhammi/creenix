        ...
        <section class="fh5co-cover3">
            <div class="container">
                <div class="header-text">
                    ...
                    <p class="text-center">Place Order and we'll call you in a jiffy!</p>
                </div>
            </div>
        </section>
                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-7 col-sm-7 col-xs-12 m-lr-auto m-b-50">
                            <div class="p-lr-40 how-shadow1 p-t-30 p-b-40 m-l-63 m-lr-0-xl p-lr-15-sm">
                                ...
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;">Mockup Design : ₦10,000.00</h4>
                                    <p><h4>Job Delivery : 2 working days</h4></p>
                                </div><br>
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;"><strong>Packages Include</strong></h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; 2 Sample Designs</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; 3 Sample Mockups</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Dynamic Orientations</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Branding</h4>
                                </div><br>
                                <div class="stext-109 cl2">
                                    <h5 style="color: #71aa68; padding-bottom: 10px;">How many Mockup Design?
                                    </h5>
                                </div>
                                ...
                                <div class="bg0 m-b-12" id="pick" style="display:none">
                                    ...
                                    <i class="icon">₦</i>
                                    <input name="budget" type="number" min="5000" max="10000" class="xo stext-111 cl8 plh3 size-111 p-lr-15" placeholder="What's your budget?">
                                </div>
