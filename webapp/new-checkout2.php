                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-7 col-sm-7 col-xs-12 m-lr-auto m-b-50">
                            <div class="p-lr-40 how-shadow1 p-t-30 p-b-40 m-l-63 m-lr-0-xl p-lr-15-sm">
                                ...
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;">Full-Stack Website : <?php echo $web_price3; ?></h4>
                                    <p><h4>Job Delivery : 5 working days</h4></p>
                                </div><br>
                                <div class="stext-111" style="font-family: 'century Gothic', sans-serif; letter-spacing: 1px">
                                    <h4 style="line-height: 1.6923;"><strong>Packages Include</strong></h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Multiple Pages</h4>
                                    ...
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; 6gb Bandwidth Storage</h4>
                                </div><br>
