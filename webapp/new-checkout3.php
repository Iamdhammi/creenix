...
<?php require_once('includes/checkingprice.php') ?>
<?php
session_start();
...
<html>
    ...
    <body>
        ...
        <div class="fh5co-offcanvas">
            <ul>
                <li><a href="landing-page.php"><i class="icon-home"></i> Home</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-7 col-sm-7 col-xs-12 m-lr-auto m-b-50">
                            <div class="p-lr-40 how-shadow1 p-t-30 p-b-40 m-l-63 m-lr-0-xl p-lr-15-sm">
                                ...
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;">E-Commerce : <?php echo $web_price4; ?></h4>
                                    <p><h4>Job Delivery : 7 working days</h4></p>
                                </div><br>
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;"><strong>Packages Include</strong></h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Dynamic Pages</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Responsive</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Active Blog</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Social Media Feeds</h4>
                                    ...
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Single Subdomain</h4>
                                    ...
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; 12gb Bandwidth Storage</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Woocommerce</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Google Listing</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Web Analytics</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Client-side Software</h4>
                                    <h4><i class="icon-check" style="color: #71aa68;"></i> &nbsp; Multiple Admin Accounts</h4>
                                </div><br>
