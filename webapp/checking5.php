                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-7 col-sm-7 col-xs-12 m-lr-auto m-b-50">
                            <div class="p-lr-40 how-shadow1 p-t-30 p-b-40 m-l-63 m-lr-0-xl p-lr-15-sm">
                                ...
                                <div class="stext-111">
                                    <h4 style="line-height: 1.6923;">Digital Print: Price may vary</h4>
                                    <h4>Job Delivery: 2 working days</h4>
                                </div><br>
                                <div class="stext-109 cl2">
                                    <h5 style="color: #71aa68">What kind of print?</h5>
                                </div>
                                <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                    <select name="printype" class="sell js-select2" id="showform7" onchange="showhideForm7(this.value);">
                                        <option value="select">Select option..</option>
                                        <option value="ComplementaryCards">Complementary Cards</option>
                                        <option value="Eflyers">E-Flyers</option>
                                        <option value="Banners">Banners</option>
                                        <option value="BrandedItems">Branded Items</option>
                                        <option value="CustomizedItems">Customized Items</option>
                                    </select>
                                    <div class="dropDownSelect2"></div>
                                </div>
                                <div class="bor8 bg0 m-b-12" id="pick71" style="display:none">
                                    <input type="text" name="cardsize" class="control stext-111 cl8 plh3 size-111 p-lr-15" placeholder="Size e.g 9 by 5 cm">
                                </div>
                                <div class="bor8 bg0 m-b-12" id="pick7" style="display:none">
                                    <input type="text" name="eflyersize" class="control stext-111 cl8 plh3 size-111 p-lr-15" placeholder="Size e.g 6 by 4 inches">
                                </div>
                                <div class="bor8 bg0 m-b-12" id="pick8" style="display:none">
                                    <input type="text" name="bannersize" class="control stext-111 cl8 plh3 size-111 p-lr-15" placeholder="Size e.g 6 by 4 feet">
                                </div>
                                <div id="pick9" style="display:none" class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                    <select name="brandedtype" class="sell js-select2">
                                        <option>What kind of Branded Item?</option>
                                ...
                                <div id="pick10" style="display:none" class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                    <select name="customtype" class="sell js-select2">
                                        <option>What kind of Customized Item?</option>
                                        <option>Shirts</option>
                                        <option>Caps</option>
                                ...
                                <div class="stext-109 cl2">
                                    <h5 style="color: #71aa68; padding-bottom: 5px">Select quantity</h5>
                                </div>
                                <div class="bor8 bg0 m-b-12">
                                    <input name="quantity" type="number" class="stext-111 cl8 plh3 size-111 p-lr-15" value="12" min="12">
                                </div>
                                <div class="stext-109 cl2">
                                    <h5 style="color: #71aa68;">Already have a design?</h5>
                                </div>
                                <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                    <select class="sell js-select2" id="showform11" onchange="showhideForm11(this.value);">
                                        <option value="no11">Select option..</option>
                                        <option value="no111">Yes, i have</option>
                                        <option value="yes11">No, i don't</option>
                                    </select>
                                    <div class="dropDownSelect2"></div>
                                </div>
                                <div class="stext-109 cl2" id="pick11" style="display:none">
                                    <h5><a href="design.html" style="color: #71aa68; text-decoration: none; cursor: pointer"><font style="color: #ff0000">*</font> Please go back and choose a Branding package <font style="color: #ff0000">*</font></a></h5>
                                </div>
                                <div class="stext-109 cl2" id="pick111" style="display:none">
                                    <h5 style="color: #71aa68; padding-bottom: 5px; text-decoration: none; cursor: pointer"><font style="color: #ff0000">*</font> Please upload a drive link to the raw image file <font style="color: #ff0000">*</font></h5>
                                    <div class="bor8 bg0 m-b-12">
                                        <input type="text" name="drivelink" class="stext-111 cl8 plh3 size-111 p-lr-15" placeholder="https://googledrive.com">
                                    </div>
                                    <div class="bor8 bg0 m-b-12">
